	...
	<div style="margin-bottom: 30px;" class="w3-top">
		<div style="margin-bottom: 30px height:30px"
			...
			<a href="profile.php"
				...
				title="View profile">Profile <i class="fa fa-user"></i></a> <a
				href=""
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"
			...
			<div class="w3-dropdown-hover w3-hide-small">
				...
				<div class="w3-dropdown-content w3-card-4 w3-bar-block"
					...
					<a href="#" class="w3-bar-item w3-button">John Doe posted on your
						wall</a> <a href="#" class="w3-bar-item w3-button">Jane likes your
						post</a>
				</div>
			</div>
			...
			<a href="#"
				...
				title="My Account"> </a> <a
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"
				id="signin" href="signout.php">Sign out</a> <a
				class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white"
